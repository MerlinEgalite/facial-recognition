...
output = '/Users/merlinegalite/Desktop/CS/CodingWeeks/facialrecognition/Test/Film_test.avi'
display = 0

def face_webcam_recognize_write(output, display):
    """
	_ brief: return the webcam video with the name of the persons present in
	the video if they are in the dataset
	_ param: (string) path to the new video
	        1 for display to show the video 0 otherwise
	_ return: the output video in a the path
	"""
